...
class CyclesTasks {
    ...
    void fromOneToTenNumberSevenMultiplicationStringBuilderSolution() {
        System.out.println("7 multiplication table over StringBuilder:");
        StringBuilder stringBuilder = new StringBuilder();
        for (int i = 1; i <= 10; i++) {
            stringBuilder.append("7 * ").append(i).append(" = ").append(7 * i).append("\n");
        }
