package com.teachMeSkills.an15.TuskalSergey.hw7.Task2.model;
...
public class Product {
    ...
    public String toString() {
        return "Наименование товара: " + name + ", цена: " + price + ", рейтинг: " + avgRate + ", количество: "
                + amount + ", комментарий: " + comment + ", марка авто: " + carNames + ", оценки: " + rates;
    }
}
